            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8">
                        <form class="form_horizontal" method="POST" action="controladores/Tips/actualizar.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="inputGroupFileAddon01">
                                                    <img src="<?php echo "controladores/Tips/Image/" . $row_Edit_M['imagen']; ?>" style="width: 20px; border-radius:35px;">
                                                </span>
                                            </div>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" accept="image/*" name="image_Fon">
                                                <input type="hidden" name="stud_image_old" value="<?php echo $row_Edit_M['imagen']; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 mb-3">
                                        <label for="textUno" class="form-label">TITULO</label>
                                        <textarea class="form-control" name="contenido" rows="5" cols="40"><?php echo $row_Edit_M['contenido']; ?></textarea>
                                    </div>
                                </div>
                            </div>
